...
const SummaryCard = ({
  ...
  <Card className="position-relative">
    ...
    <Card.Body>
      <Alert
        variant="success d-flex flex-column"
        role="alert"
      ...
      >
        <div className="" style={{ fontSize: "10px" }}>
          ...
          <p style={{ margin: 0, padding: 0 }}>
            <em>E-Ticket saves the planet. Go for eco-clean.</em>
          </p>
          <ol
            className="text-start d-inline-block text-wrap"
            style={{ maxWidth: "600px" }}
          >
            <li>
              Customers can access their tickets from the{" "}
              <strong>"My Profile"</strong> section on the mobile web. Plz
              download E-ticket Befor Visit to event Venue
            </li>
        ...
        {discount !== 0 && (
          <div className="d-flex justify-content-end mb-4">
            <TabPane
              ...
              className="tab-pane tab-example-result fade active show"
              role="tabpanel"
              aria-labelledby="alerts-disimissible-component-tab"
            >
              <Alert
                className="d-flex align-content-center justify-content-between gap-2 alert-success alert-dismissible fade show mb-0"
                role="alert"
              >
                <svg
                  width="20"
                ...
                <h6 className="p-0 m-0">
                  <Badge bg="danger">{appliedPromoCode}</Badge>
                </h6>
