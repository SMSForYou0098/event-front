...
const EventFormTabs = ({ validate, show, AccountShow, ErrorAlert,isNew }) => {
    return (
        <ul id="top-tab-list" className="p-0 row list-inline">
            {!isNew &&
                <li className={`${validate.form1 && 'active done'} ${show === "Detail" ? " active" : ""} col-lg-2 col-md-6 text-start mb-2 `}
                    id="Detail"
                    onClick={() => AccountShow('Detail')}>
                    <Link to="#">
                        ...
                        <span className="dark-wizard">Details</span>
                    </Link>
                </li>
            }
            <li className={`${validate.form2 && 'active done'} ${show === "Timing" ? " active" : ""}  mb-2 col-lg-2 col-md-6 text-start`}
                id="Timing"
                onClick={() => validate.form1 ? AccountShow('Timing') : ErrorAlert()}
            >
                <Link to="#">
                    <div className="iq-icon me-3">
                        <svg
                    ...
                    <span className="dark-wizard">Timing</span>
                </Link>
            </li>
            <li className={`${validate.form3 && 'active done'} ${show === "Ticket" ? " active" : ""} mb-2 col-lg-2 col-md-6 text-start`}
                id="Ticket"
                // onClick={() => validate.form2 === true ? AccountShow('Ticket') : ErrorAlert()}
                onClick={() => validate.form2 ? AccountShow('Ticket') : ErrorAlert()}
            >
                <Link to="#">
                    <div className="iq-icon me-3">
                        <svg
                    ...
                    <span className="dark-wizard">Ticket</span>
                </Link>
            </li>
            <li className={`${validate.form4 && 'active done'} ${show === "Location" ? " active" : ""} mb-2 col-lg-2 col-md-6 text-start`}
                id="payment"
                onClick={() => validate.form3 === true ? AccountShow('Location') : ErrorAlert()}
            >
                <Link to="#">
                    <div className="iq-icon me-3">
                        <svg
                    ...
                    <span className="dark-wizard">Location</span>
                </Link>
            </li>
            <li className={`${validate.form5 && 'active done'} ${show === "Media" ? " active" : ""} mb-2 col-lg-2 col-md-6 text-start`}
                id="payment"
                onClick={() => validate.form4 === true ? AccountShow('Media') : ErrorAlert()}
            >
                <Link to="#">
                    <div className="iq-icon me-3">
                        <svg
                    ...
                    <span className="dark-wizard">Media</span>
                </Link>
            </li>
            <li className={`${show === "Publish" ? " active done" : ""} mb-2 col-lg-2 col-md-6 text-start`}
                id="payment"
                // onClick={() => AccountShow('Publish')}
                onClick={() => validate.form5 === true ? AccountShow('Publish') : ErrorAlert()}
            >
                <Link to="#">
                    <div className="iq-icon me-3">
                        <svg
                    ...
                    <span className="dark-wizard">Publish</span>
                </Link>
            </li>
        </ul>
    )
