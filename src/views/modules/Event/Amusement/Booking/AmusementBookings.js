...
const AmusementBookings = memo(() => {
    ...
    const GetBookings = useCallback(async () => {
        ...
        const url = `${api}amusement-bookings/${UserData?.id}${queryParams}`;
        await axios.get(url, {
            headers: {
    ...
    const columns = [
        ...
        },
        {
            ...
            formatter: (cell, row) => {
                ...
                return (
                    <span className={`badge p-1 bg-${status === "0" ? "warning" : "success"}`}>
    ...
    return (
        <Fragment>
            ...
            <CommonListing
                ...
                bookings={bookings}
                dateRange={dateRange}
                exportPermisson={'Export Amusement Bookings'}
                loading={loading}
                columns={columns}
...
AmusementBookings.displayName = "AmusementBookings";
export default AmusementBookings;
